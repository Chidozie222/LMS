...
UpdateSa.use(express.static('public'))

// Post all teachers from database

UpdateTeacher.post('/Updateteachers', upload.fields([{ name: 'StudentPicture', maxCount: 1 }, { name: 'ParentPicture', maxCount: 1 }]), async (req, res) => {
