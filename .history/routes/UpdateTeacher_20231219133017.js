        ...
        if (TP > MaxFileSize) {
                ...
                await Teachers.updateOne(
                    {SchoolEmail, TeacherUsername},
                    {
                        $set:
                        {
                            TeacherMale, TeacherFemale, TeacherOther,  TeacherFirstName, TeacherMiddleName, TeacherLastName, TeacherDoB, TeacherBloodGroup, TeacherUsername, TeacherPhoneNumber, TeacherQulification, TeacherAddress, TeacherCity, TeacherCountry, TeacherZipCode, TeacherJoiningDate, TeacherLeavingDate, TeacherCurrentPosition, TeacherEmployeeCode, TeacherWorkingHours, SchoolEmail
                        }
                    }
                )
