...
TeacherAttendance.post('/Attendance', async (req, res) => {
    const { Date, RollNumber, TeacherFirstName, TeacherLastName, Absent, Reason, SchoolEmail } = req.body 

    let UserByClassAndDate = await TeacherAttendances.find({ SchoolEmail, Date })
