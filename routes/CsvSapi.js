                        ...
                        if (UserByClass.length > UserByClassCapacity[0].ClassCapacity) {
                            ...
                            res.send({status: 'error', message: 'User Already exists'})
                                ...
                                await SAPI.insertMany([{
                                    ...
                                    ParentGender: item.ParentGender, 
                                    ...
                                    ParentBloodGroup: item.ParentBloodGroup,
                                    ParentEmail: item.ParentEmail,
                                    ParentPhone: item.ParentPhone,
                                    ParentEducation: item.ParentEducation,
                                    ParentProfession: item.ParentProfession,
